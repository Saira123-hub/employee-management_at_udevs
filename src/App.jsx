      ...
      <Toolbar>
        ...
        {!user ? (
          ...
          <>
            ...
            {user.role === "user" && <Button color="inherit" component={Link} to="/profile">Profile</Button>}
...
function ProtectedRoute({ element, allowedRoles }) {
  ...
  if (!user) return <CircularProgress sx={{ display: "block", mx: "auto", my: 4 }} />;

  return allowedRoles.includes(user.role) ? element : <Login />;
}
